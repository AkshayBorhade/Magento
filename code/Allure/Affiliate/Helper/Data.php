...
namespace Allure\Affiliate\Helper;
...
use Allure\Affiliate\Helper\AbstractData;
...
class Data extends AbstractData
{
    ...
    */
	...
	public function getConfigValue($field, $storeId = null,$scopeType = ScopeInterface::SCOPE_STORE)
	{
	...
	public function getSharingUrl($url = null, $params = array(), $urlType = null)
	{
		...
		if ($this->getAffiliateConfig('general/url/param') == \Allure\Affiliate\Model\Config\Source\Urlparam::PARAM_ID) {
			$accountCode = $this->getCurrentAffiliate()->getId();
		}
		if ($urlType == \Allure\Affiliate\Model\Config\Source\Urltype::TYPE_HASH) {
