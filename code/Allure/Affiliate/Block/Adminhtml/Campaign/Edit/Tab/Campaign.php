...
class Campaign extends \Magento\Backend\Block\Widget\Form\Generic implements \Magento\Backend\Block\Widget\Tab\TabInterface
{
	 ...
	 * Status options
	 *
	 * @var \Allure\Affiliate\Model\Campaign\Status
	 */
	protected $_status;
	...
	/**
	 * @type \Allure\Affiliate\Model\Account\Group
	 */
	protected $_group;

	/**
	 * @type \Allure\Affiliate\Model\Campaign\Display
	 */
	protected $_display;

	/**
	 * @param \Magento\Config\Model\Config\Source\Yesno $boolean
	 * @param \Allure\Affiliate\Model\Campaign\Status $status
	 * @param \Allure\Affiliate\Model\Account\Group $group
	 * @param \Allure\Affiliate\Model\Campaign\Display $display
	...
	public function __construct(
		...
		\Allure\Affiliate\Model\Campaign\Status $status,
		\Allure\Affiliate\Model\Account\Group $group,
		\Allure\Affiliate\Model\Campaign\Display $display,
