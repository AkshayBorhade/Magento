...
class View extends \Magento\Backend\Block\Widget\Form\Container
{
	...
	protected function _construct()
	{
		...
		if ($transaction->getStatus() != \Allure\Affiliate\Model\Transaction\Status::STATUS_CANCELED) {
		...
		if ($transaction->getStatus() == \Allure\Affiliate\Model\Transaction\Status::STATUS_HOLD) {
