...
namespace Allure\Affiliate\Block\Adminhtml\Transaction\View\Tab;

use \Allure\Affiliate\Model\Transaction\Type;
use \Allure\Affiliate\Model\Transaction\Status;
use Magento\Framework\Json\Helper\Data as JsonHelper;

/**
 * Class Transaction
 * @package Allure\Affiliate\Block\Adminhtml\Transaction\View\Tab
 */
...
{
	/**
	 * @var \Allure\Affiliate\Model\Transaction\Type
	 */
	protected $_transactionType;

	/**
	 * @var \Allure\Affiliate\Model\Transaction\Status
	 */
	...
	/**
	 * @param \Allure\Affiliate\Model\Transaction\Type $type
	 * @param \Allure\Affiliate\Model\Transaction\Status $status
