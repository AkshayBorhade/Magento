...
/**
 * Class Signuppost
 * @package Allure\Affiliate\Controller\Account
 */
class Signuppost extends \Allure\Affiliate\Controller\Account
{
	/**
	...
	public function execute()
	{
		...
		try {
			...
			if ($account->getStatus() == \Allure\Affiliate\Model\Account\Status::NEED_APPROVED) {
