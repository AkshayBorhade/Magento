...
use Allure\Affiliate\Model\Withdraw\Status;
...
class Withdraw extends \Magento\Framework\Model\AbstractModel
{
	...
	public function __construct(
		...
		\Allure\Affiliate\Helper\Payment $helper,
	...
	{
		$this->_init('Allure\Affiliate\Model\ResourceModel\Withdraw');
	}
	...
	public function beforeSave()
	{
		...
		if (!$this->getStatus()) {
			$this->setStatus(\Allure\Affiliate\Model\Withdraw\Status::PENDING);
		}
	...
	public function prepareData()
	{
		...
		if (!$this->getTransactionId()) {
			$transaction = $this->objectManager->create('Allure\Affiliate\Model\Transaction')
	...
	public function getStatusLabel($status = null)
	{
		...
		$statusHash = $this->objectManager->create('\Allure\Affiliate\Model\Withdraw\Status')->getOptionHash();
	...
	public function getAffiliateAccount()
	{
		if (!$this->hasData('affiliate_account')) {
			$this->setData('affiliate_account',
				$this->objectManager->create('\Allure\Affiliate\Model\Account')->load($this->getAccountId())
			);
		}
