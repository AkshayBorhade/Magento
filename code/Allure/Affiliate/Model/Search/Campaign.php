...
namespace Allure\Affiliate\Model\Search;
...
class Campaign extends \Magento\Framework\DataObject
{
    ...
    public function load()
    {
        ...
        foreach ($collection as $campaign) {
            $result[] = [
                'id' => 'allure_affiliate_campaign/1/' . $campaign->getId(),
                ...
                'url' => $this->_adminhtmlData->getUrl('allure_affiliate/campaign/edit', ['campaign_id' => $campaign->getId()]),
            ];
        }
