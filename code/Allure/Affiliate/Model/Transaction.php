...
class Transaction extends \Magento\Framework\Model\AbstractModel
{
	...
	{
		$this->_init('Allure\Affiliate\Model\ResourceModel\Transaction');
	}
  ...
  //       }
	...
	public function getActionModel($code)
	{
		...
		if ($actionClass) {
			...
			if (is_object($action) && ($action instanceof \Allure\Affiliate\Model\Transaction\AbstractAction)) {
				return $action;
			}
		}
	...
	{
		$statusModel = $this->objectManager->create('\Allure\Affiliate\Model\Transaction\Status');
