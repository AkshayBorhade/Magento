...
namespace Allure\Affiliate\Model\ResourceModel\Campaign;
...
class Collection extends \Magento\Framework\Model\ResourceModel\Db\Collection\AbstractCollection
{
	 ...
	 * @var string
	 */
	protected $_eventPrefix = 'allure_affiliate_campaign_collection';
	...
	{
		$this->_init('Allure\Affiliate\Model\Campaign', 'Allure\Affiliate\Model\ResourceModel\Campaign');
	}
	...
	public function getAvailableCampaign($affiliateGroupId, $websiteId, $filterDate = true, $customerGroupId = null)
	{
		$this->addFieldToFilter('website_ids', array('finset' => $websiteId))
			->addFieldToFilter('status', \Allure\Affiliate\Model\Campaign\Status::ENABLED);
