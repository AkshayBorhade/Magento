...
use Allure\Affiliate\Helper\Data as DataHelper;
use Magento\Customer\Model\CustomerFactory;
use Allure\Affiliate\Model\Account\Status;
...
class Account extends \Magento\Framework\Model\AbstractModel
{
	...
	{
		$this->_init('Allure\Affiliate\Model\ResourceModel\Account');
	}
	...
	{
		return $this->getStatus() == \Allure\Affiliate\Model\Account\Status::ACTIVE;
	}
