 ...
 */
namespace Allure\Affiliate\Model\Total\Order\Creditmemo;
...
class Affiliate extends \Magento\Sales\Model\Order\Creditmemo\Total\AbstractTotal
{
    ...
    public function collect(\Magento\Sales\Model\Order\Creditmemo $creditmemo)
    {
        ...
        if($commission){
            $commission = \Magento\Framework\App\ObjectManager::getInstance()->get('\Allure\Affiliate\Helper\Data')->unserialize($commission);
            $refundCommission = [];
