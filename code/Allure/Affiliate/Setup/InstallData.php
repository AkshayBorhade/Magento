...
namespace Allure\Affiliate\Setup;
...
class InstallData implements InstallDataInterface
{
	...
	public function install(ModuleDataSetupInterface $setup, ModuleContextInterface $context)
	{
		...
		$setup->getConnection()->insertMultiple(
			$setup->getTable('allure_affiliate_group'),
			[
		...
		$setup->getConnection()->insert($setup->getTable('allure_affiliate_campaign'), $this->getCampaignDefaultData());
	...
	public function getCampaignDefaultData()
	{
		return [
			...
			'status'              => \Allure\Affiliate\Model\Campaign\Status::ENABLED,
			'website_ids'         => '1',
			'affiliate_group_ids' => '1,2,3,4,5',
			'display'             => \Allure\Affiliate\Model\Campaign\Display::ALLOW_GUEST,
