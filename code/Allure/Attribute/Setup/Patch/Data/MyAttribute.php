...
class MyAttribute implements DataPatchInterface {
    ...
    public function apply() {
        ...
        $eavSetup->removeAttribute(\Magento\Catalog\Model\Product::ENTITY, 'productdesign');

        $eavSetup->addAttribute(
                \Magento\Catalog\Model\Product::ENTITY, 'productdesign', [
            'type' => 'int',
            'backend' => '',
            'frontend' => '',
            'label' => 'productdesign',
