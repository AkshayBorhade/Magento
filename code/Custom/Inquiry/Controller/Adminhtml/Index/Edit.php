...
class Edit extends \Magento\Backend\App\Action
{
     ...
     * @see _isAllowed()
     */
    const ADMIN_RESOURCE = 'Custom_Inquiry::data';
    ...
    public function __construct(
        ...
        \Custom\Inquiry\Model\InquiryFactory $collectionFactory
    ) {
    ...
    protected function _initAction()
    {
        ...
        $resultPage->setActiveMenu('Custom_Inquiry::data')
    ...
    public function execute()
    {
        ...
        $resultPage->addBreadcrumb(
            $id ? __('Edit Color') : __('New Inquiry'),
            $id ? __('Edit Color') : __('New Inquiry')
        );
