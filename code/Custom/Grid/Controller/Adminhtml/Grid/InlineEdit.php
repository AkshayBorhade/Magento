...
use Custom\Grid\Model\Grid as ModelFactory;
...
class InlineEdit extends \Magento\Backend\App\Action
{
    ...
    {
        return $this->_authorization->isAllowed('Custom_Grid::custom_grid');
    }
    ...
    public function execute()
    {
        ...
        foreach (array_keys($postItems) as $App_id) {
            /** @var \Magento\Cms\Model\Page $page */
            $Model = $this->ModelFactory->load($App_id);
            try {
                $Data = $this->filterPost($postItems[$App_id]);
